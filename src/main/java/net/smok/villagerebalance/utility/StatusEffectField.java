...
public record StatusEffectField(StatusEffect statusEffect, int duration) implements JsonConvertible<StatusEffectField> {
    @Override
    public StatusEffectField childFromJson(@NotNull JsonObject json) {
        ...
        return new StatusEffectField(statusId, duration);
    }
